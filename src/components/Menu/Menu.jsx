                    ...
                    <div className="p-6">
                            ...
                            <h1 className="text-[#E2698D] font-bold text-2xl">HerVest</h1>
                                ...
                                <ul className="list-none px-4 ">
                                    <li> 
                                        <div className="pt-2 hover:text-[#E2698D]">
            ...
            <section>
                ...
                <div className='hidden md:block w-64 bg-white border-r border-gray-200'>  
                    ...
                    <div className="p-6">
                            ...
                            {/* <img src={HerVest} alt='HerVest' style={{display:"inline"}}/>  */}
                            <h1 className="text-[#E2698D] font-bold text-2xl">HerVest</h1>
                            {/* <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-x ml-20 cursor pointer"  viewBox="0 0 16 16">
