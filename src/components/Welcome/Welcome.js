    ...
    return(
        <div>
            <div className="flex flex-row items-center space-x-4 p-2 shadow-md hover:bg-rosh-100 transition ease-in duration-300 pb-2">
                <img className="hidden md:block w-20 rounded-3xl" src={woman} alt="user" />
            ...
            <div className=' bg-[#E2698D] p-5 md:p-10 rounded-lg md:bg-pinkbg '>
                <div class="mx-auto grid grid-cols-2 gap-2 items-center lg:grid-cols-4 lg:justify-around ... text-white">
                    <div>
