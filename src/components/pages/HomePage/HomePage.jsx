...
const HomePage = () => {
    return(
        <div>
            ...
            <div className="relative container mx-auto z-40 bg-[#09C5AD] mt-5 text-center rounded-3 space-y-20 mb-48">
                ...
                <div className=''>
                    ...
                    <button className="bg-blue-600 hover:bg-blue-dark text-white text-xs font-bold py-2 px-6  rounded" type="button">
                        BOOK NOW
                    </button>
